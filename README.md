...
## This repository gives information on how to set up four different 5G UPF Implementations: SPGWU-UPF, VPP-UPF, P4-Switch-UPF and SmartNIC-P4-UPF, utilizing the OpenAirInterface 5G framework.
